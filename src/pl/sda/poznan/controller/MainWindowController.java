...
public class MainWindowController {
    ...
    public void connectToServer(ActionEvent actionEvent) {
        ...
        dialog.setTitle("Polacz do serwera");
    ...
    public void connectToServer(ConnectionDialogViewModel viewModel) {
        logger.log(Level.INFO, String.format("Trying to connect to server at address %s with username %s", viewModel.getServerAddress(), viewModel.getPlayerName()));
    }
}
